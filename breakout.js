...
//players
let playerWidth = 90; //500 for testing, 80 normal
let playerHeight = 10;
...
let ballWidth = 10;
let ballHeight = 10;
let ballVelocityX = 3*1.5; //15 for testing, 3 normal
let ballVelocityY = 2*1.5; //10 for testing, 2 normal
...
window.onload=function display(){
    ...
    context.fillText("press any key to start", 140, boardHeight/2);
